...
parser.add_argument("--emac_in", help="EMAC input file path")#, default='/work/mm0062/b302074/Data/AirQuality/AQABA/IC_BC/geo_em.d01.nc')
...
#%% local use case for EMAC EMME sim & GHS population dataset
args.emac_in = '/home/b/b302052/work/people/evgenia/EPFM/data/CTRL/CTRL__2099__ECHAM5.nc'
args.sedac_in = '/Users/osipovs/Data/NASA/SEDAC/population_count/30_minutes_res/gpw_v4_population_count_rev11_30_min.nc'
args.sedac_out = '/Users/osipovs/Data/NASA/SEDAC/population_count/30_minutes_res/gpw_v4_population_count_rev11_30_min_regrid_to_emac.nc'
