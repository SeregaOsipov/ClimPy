...
This is done to speed up the comparison with WRF and to avoid reading large WRF output

This version runs in parallel for all wrf files but serial for each station 
'''
...
print('You should allocate {} CPUs, to accommodate to {} wrf files per stations'.format(len(wrf_in_paths), len(wrf_in_paths)))
