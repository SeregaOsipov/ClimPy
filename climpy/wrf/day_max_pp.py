...
'''
Run examples:
python -u ${CLIMPY}/climpy/wrf/day_max_pp.py --var_keys=twb --wrf_in=/scratch/osipovs/Data/COAWST/EMME/2017/HLT/chem_100_v1/output/pp_wrf/wrfout_d01_2017-*_00_00_00 --wrf_out=/scratch/osipovs/Data/COAWST/EMME/2017/HLT/chem_100_v1/output/pp_wrf/wrfout_d01_day_max

# COAWST, twb (pp_wrf)
rootPath=/scratch/osipovs/  # Shaheen # HLT
for scenario in CLE MFR MFR_LV present_day/aer_on present_day/aer_off
do
    echo $scenario
    simPath=${rootPath}/Data/COAWST/EMME/2017/${scenario}/
    
    # hourly
    python -u ${CLIMPY}/climpy/wrf/day_max_pp.py --var_keys=twb --wrf_in=${simPath}/chem_100_v1/output/pp_wrf/wrfout_d01_*_00 --wrf_out=${simPath}/chem_100_v1/output/pp_wrf/wrfout_d01_day_max
    #python -u ${CLIMPY}/climpy/wrf/day_max_pp.py --var_keys=T2,Q2 --wrf_in=${simPath}/chem_100_v1/output/wrfout_d01_*_00 --wrf_out=${simPath}/chem_100_v1/output/pop_wtd/wrfout_d01_hourly_pop_wtd &
done
wait
'''
...
#debug
# hourly
# args.wrf_in='/scratch/osipovs/Data/COAWST/EMME/2017/HLT/chem_100_v1/output/pp_wrf/wrfout_d01_2017-01-*_00_00_00'
# args.wrf_out='/scratch/osipovs/Data/COAWST/EMME/2017/HLT/chem_100_v1/output/pp_wrf/wrfout_d01_2017-01_00_00_00_daily_max'
...
#%%
with warnings.catch_warnings():  # suppress NA warnings
