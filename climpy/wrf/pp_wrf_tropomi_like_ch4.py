...
args.wrf_out = '/scratch/osipovs/Data/AirQuality/THOFA/inversion/v4/run_srs_ref/pp/tropomi_like/wrfout_d01_2023-06-10_00_00_00'
...
wrf_ds['xch4_like_tropomi'] = 10**6 * wrf_ds['vch4'] / wrf_ds['dvair'].sum('layer')  # ppmv. This is like-for-like diagnsotic
#%% Save the output
print('Saving to:\n{}'.format(args.wrf_out))
